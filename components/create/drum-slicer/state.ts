...
export const EQ_PRESETS: Record<string, { label: string; bands: SliceFxSettings["eq"]["bands"] }> = {
  ...
  hat: {
    label: "Hi-Hat – Bright",
    bands: [
      { freq: 350, gain: -2, q: 1.2, type: "bell" },
      { freq: 700, gain: -2, q: 1.2, type: "bell" },
      { freq: 8000, gain: 5, q: 0.9, type: "bell" },
      { freq: 12000, gain: 2, q: 0.8, type: "high_shelf" },
      { freq: 10000, gain: -2, q: 1, type: "bell" },
      { freq: 60, gain: 0, q: 1, type: "low_shelf" },
    ],
  },
  perc: {
    label: "Perc – Clear",
    bands: [
      ...
      { freq: 5500, gain: 3, q: 1, type: "bell" },
      { freq: 10000, gain: -1, q: 1.2, type: "bell" },
      { freq: 200, gain: 0, q: 1, type: "bell" },
      { freq: 12000, gain: 0, q: 1, type: "high_shelf" },
    ],
  },
  generic: {
    label: "Neutral",
    bands: [
      { freq: 80, gain: 0, q: 0.8, type: "low_shelf" },
      { freq: 250, gain: 0, q: 1, type: "bell" },
      { freq: 1000, gain: 0, q: 1, type: "bell" },
      { freq: 4000, gain: 0, q: 1, type: "bell" },
      { freq: 8000, gain: 0, q: 1, type: "bell" },
